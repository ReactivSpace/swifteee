angular.module('App.ShiftsCtrl', [])
.controller('ShiftsCtrl', function($scope, $rootScope, $firebaseArray, $state, loader){
  ...
  shifter.$loaded().then(function(resp){
    ...
    $scope.getHospoital = function(hosp_id)
    {
      var refer = firebase.database().ref("hospitals/"+hosp_id);
